...
export interface VideoProps {
  ...
  danmuList: Array<object>; //	否	弹幕列表	1.0.0
  ...
  onTimeUpdate: (event: any) => any; //否	播放进度变化时触发，event.detail = {currentTime, duration} 。触发频率 250ms 一次	1.0.0
  onFullScreenChange: (event: any) => any; //		否	视频进入和退出全屏时触发，event.detail = {fullScreen, direction}，direction 有效值为 vertical 或 horizontal	1.4.0
