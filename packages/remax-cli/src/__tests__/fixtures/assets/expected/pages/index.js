...
var index$t = require('../npm/remax/npm/remax-alipay/esm/hostComponents/Image/index.js');
...
function _ref() {
  return React.createElement(index$2.default, null, React.createElement(index$t.default, {
    src: cat.default
  }));
}
