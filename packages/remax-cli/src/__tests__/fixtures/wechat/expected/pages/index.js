...
var index$6 = require('../npm/remax/npm/remax-wechat/esm/hostComponents/Swiper/index.js');
var index$7 = require('../npm/remax/npm/remax-wechat/esm/hostComponents/ScrollView/index.js');
...
var _page = function _page() {
  ...
  return React.createElement(index$2.default, null, React.createElement(index$2.default, _rollupPluginBabelHelpers.extends({
    ...
    id: "view",
    "data-foo": "bar"
  }, props), "foo"), TextElement, React.createElement(index$H.Lifestyle, null), React.createElement(UnBindingComponent, null), React.createElement(index$7.default, null), React.createElement(index$6.default, null));
};
