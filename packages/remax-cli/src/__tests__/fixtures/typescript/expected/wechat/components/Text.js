...
require('../npm/remax/npm/remax-wechat/esm/hostComponents/View/index.js');
...
function Text() {
  ...
  switch (Platform.default.current) {
    ...
    case 'toutiao':
      return React.createElement(index$H.Text, props);

    case 'wechat':
    default:
      return React.createElement(index$e.default, props);
  }
}
