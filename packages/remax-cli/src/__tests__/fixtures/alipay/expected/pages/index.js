...
var _page = function _page() {
  ...
  var props = {};
  var TextElement = React.cloneElement(React.createElement(alipay.Text, null));
  ...
  return React.createElement(alipay.View, {
    className: styles['page-index']
  }, React.createElement(alipay.View, index$1._extends({
    onClick: handleClick,
