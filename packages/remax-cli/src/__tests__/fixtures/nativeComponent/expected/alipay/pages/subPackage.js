...
var PluginComponent2 = createNativeComponent.default('sub-plugin-1');
var PluginComponent = createNativeComponent.default('sub-plugin-0');



var _page = function _page() {
  return React.createElement(index$1$1.default, null, React.createElement(PluginComponent, null), React.createElement(PluginComponent2, null));
};

var subPackage = Page(createPageConfig.default(_page));
