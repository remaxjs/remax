...
var _page = function _page() {
  return React.createElement(index$2.default, null, React.createElement(index.default, null), React.createElement(B, null));
};

var index4 = Page(createPageConfig.default(_page));
