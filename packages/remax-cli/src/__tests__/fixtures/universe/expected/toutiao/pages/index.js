...
var index$1 = require('../index-9b51d992.js');
...
var ToutiaoView = createHostComponent('view');
...
var ToutiaoText = createHostComponent('text');
...
function View$2() {
  ...
  switch (index$1.Platform.current) {
    ...
    case 'toutiao':
      return React.createElement(ToutiaoView, props);
  }
}
...
function Text$2() {
  ...
  switch (index$1.Platform.current) {
    ...
    case 'toutiao':
      return React.createElement(ToutiaoText, props);
  }
}
