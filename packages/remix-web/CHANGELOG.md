...
**Note:** Version bump only for package @alipay/remax-web
...
- **web:** 修复文件不存在的问题 ([fcee347](https://code.alipay.com/remix/remix/commit/fcee3476cb09b7e6a750bbb04e5bb264a8bb1090))

# [2.0.0-alpha.3](https://code.alipay.com/remix/remix/compare/v2.0.0-alpha.2...v2.0.0-alpha.3) (2020-04-16)

### Bug Fixes

- **web:** 修复文件不存在的问题 ([22b3ff4](https://code.alipay.com/remix/remix/commit/22b3ff4fa546c66503e52796cf5f50ea1fca7ad5))
